<template>
	<b-modal
		...
		<div class="row d-flex justify-content-center">
			<div v-for="(data, i) in images" :key="i" class="col-md-6 my-2 text-center">
				<b-img-lazy
...
export default {
	...
	computed: {
		compTitle() {
			let title = `I've just minted ${this.mintCount} NFTs from @vfootballs_nft NFT Collection.`
		...
		compHashTags() {
			let tags = [this.smartContractName, 'nft', 'mint']
