<template>
  <div class="collect-set">
    <h2 class="collect-set__title text-center">
      Collect set of the balls and get special reward -
      unique NFT which you can change to real gold ball.
    </h2>
    <div>
