	...
	<section class="about-wrapper container-fluid mx-auto">
		<b-row class="about-wrapper__content">
			...
			<b-col xl="5" class="align-self-center">
				...
				<p class="about-wrapper__paragraph" :class="{'about-wrapper__paragraph2': index === 1 || index === paragraphData.length-1}" v-for="(paragraph,index) in paragraphData" :key="paragraph">
					{{paragraph}}
				</p>
...
export default {
	...
	setup() {
		const paragraphData = ["Our Mission is unite all football fans around the world. The Museum of Footballs project unites people together just as football does.",
			...
			"  NFT Collection will be copies of 3D balls that are present in the metaverse. We will start with a small collection (season 1) " +
			"and launch more seasons in the future. Those drops will be tight to major football events. The first drop will be on November 27 when the World Cup 2022 in Qatar starts.",
