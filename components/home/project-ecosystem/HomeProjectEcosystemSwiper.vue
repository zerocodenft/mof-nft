          ...
          <MGradientCard>
            <template #default>
              <div class="project-ecosystem__content d-flex flex-column align-items-center">
                <b-img
                  class="d-block"
                  :class="[`project-ecosystem__logo${index+1}`]"
                  :src="require(`assets/img/project-ecosystem/${item.logo}`)"
                  alt="ball"
                />
...
export default {
  ...
  setup() {
    ...
    const projects = ref([
      ...
      {id: 2, title: 'metaverse vmuseum of footballs', description: 'vMuseum of Footballs is the official source of information on the history of each exhibit and all collection. Also this an additional tool that draws the attention of collectors around the world to our project', logo: 'web.png'},
      {id: 3, title: 'vfootballs nft collection', subTitle:"launched on Ethereum blockchain", description: "The unique NFT collection will become the sport's most prized Web3 trophy, which will be in the heart of every football fan-a must-have for future generations of football fans worldwide. Owning a piece of footballing history would surely bring back emotions from a tournament and keep them alive forever, but it will also have its significant perks.", logo: 'nft1.png'},
				 	{id: 4, title: "vgoal play-to-earn game", subTitle: '', description: "vGoal game, as the first blockchain-based football metaverse,gives its user access to manage their club and generate income while playing.In this game, every player or user can actively take part in different methods and earn rewards for their contributions to the ecosystem.", logo: "goggles.png"},
      {id:5, title: "website catalog with ar technology", subTitle: "", description:"The museum exists off-line, on-line, and as the world's first museum in the Metaverse. Each ball from our collection can not only be viewed, but also touched in 3D and placed anywhere you wish in augmented reality", logo: "game.png"}
    ])
